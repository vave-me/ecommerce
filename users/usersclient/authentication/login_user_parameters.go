...
// WithBody adds the body to the login user params
func (o *LoginUserParams) WithBody(body *models.UserspbLoginUserRequest) *LoginUserParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the login user params
func (o *LoginUserParams) SetBody(body *models.UserspbLoginUserRequest) {
	o.Body = body
}
