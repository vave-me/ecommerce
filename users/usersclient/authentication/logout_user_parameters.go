...
type LogoutUserParams struct {
	...
	// Body.
	Body *models.UserspbLogUserOutRequest
...
// WithBody adds the body to the logout user params
func (o *LogoutUserParams) WithBody(body *models.UserspbLogUserOutRequest) *LogoutUserParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the logout user params
func (o *LogoutUserParams) SetBody(body *models.UserspbLogUserOutRequest) {
	o.Body = body
}
