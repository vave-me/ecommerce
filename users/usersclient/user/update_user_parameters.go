...
type UpdateUserParams struct {
	...
	// Body.
	Body *models.UsersServiceUpdateUserBody
...
func (o *UpdateUserParams) WithBody(body *models.UsersServiceUpdateUserBody) *UpdateUserParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update user params
func (o *UpdateUserParams) SetBody(body *models.UsersServiceUpdateUserBody) {
	o.Body = body
}
