...
type AddAdminParams struct {
	...
	*/
	Body *models.UserspbAddAdminRequest
...
func (o *AddAdminParams) WithBody(body *models.UserspbAddAdminRequest) *AddAdminParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the add admin params
func (o *AddAdminParams) SetBody(body *models.UserspbAddAdminRequest) {
	o.Body = body
}
