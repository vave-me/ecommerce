...
type EnableUserParams struct {
	...
	// Body.
	Body *models.UsersServiceEnableUserBody
...
func (o *EnableUserParams) WithBody(body *models.UsersServiceEnableUserBody) *EnableUserParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the enable user params
func (o *EnableUserParams) SetBody(body *models.UsersServiceEnableUserBody) {
	o.Body = body
}

// WithID adds the id to the enable user params
func (o *EnableUserParams) WithID(id string) *EnableUserParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the enable user params
func (o *EnableUserParams) SetID(id string) {
	o.ID = id
}
