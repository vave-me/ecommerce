...
func (o *UpdateUserOK) Error() string {
	...
	return fmt.Sprintf("[PATCH /api/users/{id}/update][%d] updateUserOK %s", 200, payload)
}
...
func (o *UpdateUserDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /api/users/{id}/update][%d] updateUser default %s", o._statusCode, payload)
}
