...
type ResetPasswordParams struct {
	...
	// Body.
	Body *models.UserspbResetPasswordRequest
...
func (o *ResetPasswordParams) WithBody(body *models.UserspbResetPasswordRequest) *ResetPasswordParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the reset password params
func (o *ResetPasswordParams) SetBody(body *models.UserspbResetPasswordRequest) {
	o.Body = body
}
