...
type ForgotPasswordParams struct {
	...
	// Body.
	Body *models.UserspbForgotPasswordRequest
...
func (o *ForgotPasswordParams) WithBody(body *models.UserspbForgotPasswordRequest) *ForgotPasswordParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the forgot password params
func (o *ForgotPasswordParams) SetBody(body *models.UserspbForgotPasswordRequest) {
	o.Body = body
}
