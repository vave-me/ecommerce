...
// WithUserIds adds the userIds to the get users params
func (o *GetUsersParams) WithUserIds(userIds []string) *GetUsersParams {
	o.SetUserIds(userIds)
	return o
}

// SetUserIds adds the userIds to the get users params
func (o *GetUsersParams) SetUserIds(userIds []string) {
	o.UserIds = userIds
}
...
// bindParamGetUsers binds the parameter userIds
func (o *GetUsersParams) bindParamUserIds(formats strfmt.Registry) []string {
	userIdsIR := o.UserIds
