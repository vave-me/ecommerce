...
type GetUsersOK struct {
	Payload *models.UserspbGetUsersResponse
}
...
func (o *GetUsersDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/users][%d] getUsers default %s", o._statusCode, payload)
}
...
func (o *GetUsersDefault) GetPayload() *models.RPCStatus {
	return o.Payload
}
