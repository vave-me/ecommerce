...
type CreateUserParams struct {
	...
	*/
	Body *models.UserspbCreateUserRequest
...
func (o *CreateUserParams) WithBody(body *models.UserspbCreateUserRequest) *CreateUserParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create user params
func (o *CreateUserParams) SetBody(body *models.UserspbCreateUserRequest) {
	o.Body = body
}
