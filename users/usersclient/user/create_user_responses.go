...
func (o *CreateUserOK) GetPayload() *models.UserspbCreateUserResponse {
	return o.Payload
}
...
func (o *CreateUserDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/users][%d] createUser default %s", o._statusCode, payload)
}
...
func (o *CreateUserDefault) GetPayload() *models.RPCStatus {
	return o.Payload
}
