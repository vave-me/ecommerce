...
func run() (err error) {
	...
	usersCfg, err = config.InitUsersConfig()

	publicMethods := []string{
		"/userspb.UsersService/LoginUser",
		"/userspb.UsersService/CreateUser",
		"/userspb.UsersService/MobileLoginWithGoogle",
		"/userspb.UsersService/ForgotPassword",
		"/userspb.UsersService/ResetPassword",
		"/userspb.UsersService/WebLoginWithGoogle",
		"/userspb.UsersService/EnableUser",
		"/userspb.UsersService/GetBaseUser",
		"/userspb.UsersService/AddAdmin",
		"/userspb.UsersService/RefreshAuthToken",
		// Add other public methods if any
	}
	if err != nil {
		return err
	}
	s, err := system.NewUsersSystem(cfg, publicMethods, usersCfg)
	if err != nil {
		return err
	}
