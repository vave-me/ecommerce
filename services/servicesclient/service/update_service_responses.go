...
type UpdateServiceOK struct {
	Payload *models.ServicespbUpdateServiceResponse
}
...
func (o *UpdateServiceOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/services/update][%d] updateServiceOK %s", 200, payload)
}
...
func (o *UpdateServiceOK) GetPayload() *models.ServicespbUpdateServiceResponse {
	return o.Payload
}
...
func (o *UpdateServiceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ServicespbUpdateServiceResponse)
...
func (o *UpdateServiceDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/services/update][%d] updateService default %s", o._statusCode, payload)
}
...
func (o *UpdateServiceDefault) GetPayload() *models.RPCStatus {
	return o.Payload
}
