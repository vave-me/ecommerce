...
type GetServicesOK struct {
	Payload *models.ServicespbGetServicesResponse
}
...
func (o *GetServicesOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/services][%d] getServicesOK %s", 200, payload)
}
...
func (o *GetServicesOK) GetPayload() *models.ServicespbGetServicesResponse {
	return o.Payload
}
...
func (o *GetServicesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ServicespbGetServicesResponse)
...
func (o *GetServicesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/services][%d] getServices default %s", o._statusCode, payload)
}
...
func (o *GetServicesDefault) GetPayload() *models.RPCStatus {
	return o.Payload
}
