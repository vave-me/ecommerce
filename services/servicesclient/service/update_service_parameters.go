...
type UpdateServiceParams struct {
	...
	// Body.
	Body *models.ServicespbUpdateServiceRequest
...
func (o *UpdateServiceParams) WithBody(body *models.ServicespbUpdateServiceRequest) *UpdateServiceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update service params
func (o *UpdateServiceParams) SetBody(body *models.ServicespbUpdateServiceRequest) {
	o.Body = body
}
