...
// WithID adds the id to the remove service params
func (o *RemoveServiceParams) WithID(id string) *RemoveServiceParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the remove service params
func (o *RemoveServiceParams) SetID(id string) {
	o.ID = id
}
