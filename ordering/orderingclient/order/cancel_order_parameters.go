...
// WithReason adds the reason to the cancel order params
func (o *CancelOrderParams) WithReason(reason *string) *CancelOrderParams {
	o.SetReason(reason)
	return o
}

// SetReason adds the reason to the cancel order params
func (o *CancelOrderParams) SetReason(reason *string) {
	o.Reason = reason
}
