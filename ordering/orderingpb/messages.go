...
const (
	OrderAggregateChannel = "middleman.ordering.events.Order"
	...
	OrderShippedEvent   = "ordersapi.OrderShipped"
	OrderDeliveredEvent = "ordersapi.OrderDelivered"
	OrderCompletedEvent = "ordersapi.OrderCompleted"

	CommandChannel = "middleman.ordering.commands"

	RejectOrderCommand  = "ordersapi.RejectOrder"
	ApproveOrderCommand = "ordersapi.ApproveOrder"
	CreateOrderCommand  = "ordersapi.CreateOrder"
)
...
func Registrations(reg registry.Registry) (err error) {
	...
	if err = serde.Register(&OrderShipped{}); err != nil {
		return err
	}
	if err = serde.Register(&OrderDelivered{}); err != nil {
		return err
	}
	...
	if err = serde.Register(&CreateOrderRequest{}); err != nil {
		return err
	}
...
// CreateOrderRequest implements registry.Registerable so it can travel via NATS as a command
func (*CreateOrderRequest) Key() string { return CreateOrderCommand }
