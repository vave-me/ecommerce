...
func (_m *MockCommands) DeliverOrder(ctx context.Context, cmd commands.DeliverOrder) error {
	ret := _m.Called(ctx, cmd)
...
func (_m *MockCommands) ShipOrder(ctx context.Context, cmd commands.ShipOrder) error {
	ret := _m.Called(ctx, cmd)
...
func (_m *MockCommands) UpdateOrderStatus(ctx context.Context, cmd commands.UpdateOrderStatus) error {
	ret := _m.Called(ctx, cmd)
