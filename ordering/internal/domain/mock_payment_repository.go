...
// Confirm provides a mock function with given fields: ctx, paymentMethodID
func (_m *MockPaymentRepository) Confirm(ctx context.Context, paymentMethodID string) error {
