...
CREATE TRIGGER created_at_addresses_trgr
    BEFORE UPDATE
    ON addresses
    FOR EACH ROW
    EXECUTE PROCEDURE created_at_trigger();
CREATE TRIGGER updated_at_addresses_trgr
    BEFORE UPDATE
    ON addresses
    FOR EACH ROW
...
CREATE TRIGGER created_at_locations_trgr
    BEFORE UPDATE
    ON locations
    FOR EACH ROW
    EXECUTE PROCEDURE created_at_trigger();
CREATE TRIGGER updated_at_locations_trgr
    BEFORE UPDATE
    ON locations
    FOR EACH ROW
    EXECUTE PROCEDURE updated_at_trigger();
