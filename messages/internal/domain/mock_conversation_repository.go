...
// Load provides a mock function with given fields: ctx, conversationID
func (_m *MockConversationRepository) Load(ctx context.Context, conversationID string) (*Conversation, error) {
