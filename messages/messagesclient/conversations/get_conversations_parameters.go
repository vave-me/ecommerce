...
// WithLimit adds the limit to the get conversations params
func (o *GetConversationsParams) WithLimit(limit *string) *GetConversationsParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the get conversations params
func (o *GetConversationsParams) SetLimit(limit *string) {
	o.Limit = limit
}

// WithPage adds the page to the get conversations params
func (o *GetConversationsParams) WithPage(page *string) *GetConversationsParams {
	o.SetPage(page)
	return o
}

// SetPage adds the page to the get conversations params
func (o *GetConversationsParams) SetPage(page *string) {
	o.Page = page
}
