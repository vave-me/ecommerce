...
type GetMessagesParams struct {
	...
	*/
	...
	/* Limit.
	   ...
	   Number of messages per page (optional).
...
// WithConversationID adds the conversationID to the get messages params
func (o *GetMessagesParams) WithConversationID(conversationID string) *GetMessagesParams {
	o.SetConversationID(conversationID)
	return o
}

// SetConversationID adds the conversationId to the get messages params
func (o *GetMessagesParams) SetConversationID(conversationID string) {
	o.ConversationID = conversationID
}

// WithLimit adds the limit to the get messages params
func (o *GetMessagesParams) WithLimit(limit *string) *GetMessagesParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the get messages params
func (o *GetMessagesParams) SetLimit(limit *string) {
	o.Limit = limit
}

// WithPage adds the page to the get messages params
func (o *GetMessagesParams) WithPage(page *string) *GetMessagesParams {
	o.SetPage(page)
	return o
}

// SetPage adds the page to the get messages params
func (o *GetMessagesParams) SetPage(page *string) {
	o.Page = page
}
