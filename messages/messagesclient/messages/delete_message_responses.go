...
func (o *DeleteMessageOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/messages/message/{id}][%d] deleteMessageOK %s", 200, payload)
}
...
func (o *DeleteMessageDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/messages/message/{id}][%d] deleteMessage default %s", o._statusCode, payload)
}
