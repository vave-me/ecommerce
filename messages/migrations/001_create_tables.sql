...
CREATE INDEX active_conversations_idx ON conversations (active) WHERE active;

CREATE TRIGGER created_at_conversations_trgr
    BEFORE UPDATE
    ON conversations
...
CREATE INDEX conversations_messages_idx ON messages (conversation_id);
