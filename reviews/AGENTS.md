# AGENTS Guide: reviews

## Business Purpose
Manages ratings/reviews lifecycle and moderation-facing review operations.

## Service Runtime Shape
- Entry point: `sfx_markt/reviews/cmd/service/main.go`
- Module composition/wiring: `sfx_markt/reviews/module.go`
- Codegen entrypoint: `sfx_markt/reviews/generate.go`
- Application facade: `sfx_markt/reviews/internal/application/application.go`
- gRPC server implementation: `sfx_markt/reviews/internal/grpc/server.go`
- gRPC transaction wrapper: `sfx_markt/reviews/internal/grpc/server_transaction.go`
- API contract (proto): `sfx_markt/reviews/reviewspb/api.proto`
- Event contract (proto): `sfx_markt/reviews/reviewspb/events.proto`
- Message contract (proto): `(not found)`

## Concrete Files To Read First
### Proto contracts
- `sfx_markt/reviews/reviewspb/api.proto`
- `sfx_markt/reviews/reviewspb/events.proto`

### gRPC transport layer files
- `sfx_markt/reviews/internal/grpc/server.go`
- `sfx_markt/reviews/internal/grpc/server_transaction.go`

### Application command handlers
- `sfx_markt/reviews/internal/application/commands/add_review.go`
- `sfx_markt/reviews/internal/application/commands/approve_review.go`
- `sfx_markt/reviews/internal/application/commands/block_review.go`
- `sfx_markt/reviews/internal/application/commands/edit_review.go`
- `sfx_markt/reviews/internal/application/commands/flag_review.go`
- `sfx_markt/reviews/internal/application/commands/reject_review.go`
- `sfx_markt/reviews/internal/application/commands/remove_review.go`

### Application query handlers
- `sfx_markt/reviews/internal/application/queries/get_approved_reviews.go`
- `sfx_markt/reviews/internal/application/queries/get_most_reviewed.go`
- `sfx_markt/reviews/internal/application/queries/get_most_reviewed_by_category.go`
- `sfx_markt/reviews/internal/application/queries/get_reveiw.go`
- `sfx_markt/reviews/internal/application/queries/get_review.go`
- `sfx_markt/reviews/internal/application/queries/get_reviews_by_sender.go`

### Domain model files
- `sfx_markt/reviews/internal/domain/item_type.go`
- `sfx_markt/reviews/internal/domain/middleman_cache_repository.go`
- `sfx_markt/reviews/internal/domain/middleman_repository.go`
- `sfx_markt/reviews/internal/domain/registrations.go`
- `sfx_markt/reviews/internal/domain/review.go`
- `sfx_markt/reviews/internal/domain/review_events.go`
- `sfx_markt/reviews/internal/domain/review_repostitory.go`
- `sfx_markt/reviews/internal/domain/review_snapshots.go`
- `sfx_markt/reviews/internal/domain/review_status.go`

### Event/integration/projection handlers
- `sfx_markt/reviews/internal/handlers/domain_events.go`
- `sfx_markt/reviews/internal/handlers/domain_events_transaction.go`
- `sfx_markt/reviews/internal/handlers/middleman.go`
- `sfx_markt/reviews/internal/handlers/websocket_events.go`
- `sfx_markt/reviews/internal/handlers/websocket_events_transaction.go`

### Postgres/repository files
- `sfx_markt/reviews/internal/postgres/middleman_repository.go`

### SQL migrations
- `sfx_markt/reviews/migrations/001_create_tables.sql`
...
1. Run tests for this service:
   - `cd <workspace-root>/sfx_markt && go test ./reviews/...`
2. Start the service directly:
   - `cd <workspace-root>/sfx_markt && go run ./reviews/cmd/service`
3. Optional container run (if profile exists):
   - `cd <workspace-root>/sfx_markt && docker compose --env-file ./docker/.env --profile reviews up`
...
2. Regenerate this service:
   - `cd <workspace-root>/sfx_markt/reviews && go generate ./...`
3. If only proto files changed:
   - `cd <workspace-root>/sfx_markt/reviews && buf generate`
4. Re-run tests:
   - `cd <workspace-root>/sfx_markt && go test ./reviews/...`

## Add or Remove a Command (Detailed)
1. Update command request/response messages and RPC (if externally callable) in `sfx_markt/reviews/reviewspb/api.proto`.
...
1. Add query request/response messages + RPC in `sfx_markt/reviews/reviewspb/api.proto`.
...
3. Update wire contracts:
   - Use `sfx_markt/reviews/reviewspb/events.proto` for event payload contract updates.
