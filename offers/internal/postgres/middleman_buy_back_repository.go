...
type MiddlemanBuyBackRepository struct {
	tableName string
	db        postgres.DB
}

var _ domain.MiddlemanBuyBackRepository = (*MiddlemanBuyBackRepository)(nil)

func NewMiddlemanBuyBackRepository(tableName string, db postgres.DB) MiddlemanBuyBackRepository {
	return MiddlemanBuyBackRepository{
		tableName: tableName,
		db:        db,
	}
}

func (r MiddlemanBuyBackRepository) Add(ctx context.Context, offerID, userSellerID, userCustomerID, productID string, price int64) error {
...
func (r MiddlemanBuyBackRepository) Find(ctx context.Context, offerID string) (*domain.MiddlemanOffer, error) {
...
func (r MiddlemanBuyBackRepository) All(ctx context.Context, userID string) (offers []*domain.MiddlemanOffer, err error) {
...
func (r MiddlemanBuyBackRepository) table(query string) string {
