...
type MiddlemanReservationRepository struct {
	tableName string
	db        postgres.DB
}

var _ domain.MiddlemanReservationRepository = (*MiddlemanReservationRepository)(nil)

func NewMiddlemanReservationRepository(tableName string, db postgres.DB) MiddlemanReservationRepository {
	return MiddlemanReservationRepository{
		tableName: tableName,
		db:        db,
	}
}

func (r MiddlemanReservationRepository) Add(ctx context.Context, offerID, userSellerID, userCustomerID, productID string, price int64) error {
...
func (r MiddlemanReservationRepository) Find(ctx context.Context, offerID string) (*domain.MiddlemanOffer, error) {
...
func (r MiddlemanReservationRepository) All(ctx context.Context, userID string) (offers []*domain.MiddlemanOffer, err error) {
...
func (r MiddlemanReservationRepository) table(query string) string {
