...
type MiddlemanBuyNowRepository struct {
	tableName string
	db        postgres.DB
}

var _ domain.MiddlemanBuyNowRepository = (*MiddlemanBuyNowRepository)(nil)

func NewMiddlemanBuyNowRepository(tableName string, db postgres.DB) MiddlemanBuyNowRepository {
	return MiddlemanBuyNowRepository{
		tableName: tableName,
		db:        db,
	}
}

func (r MiddlemanBuyNowRepository) Add(ctx context.Context, offerID, userSellerID, userCustomerID, productID string, price int64) error {
...
func (r MiddlemanBuyNowRepository) Find(ctx context.Context, offerID string) (*domain.MiddlemanOffer, error) {
...
func (r MiddlemanBuyNowRepository) All(ctx context.Context, userID string) (offers []*domain.MiddlemanOffer, err error) {
...
func (r MiddlemanBuyNowRepository) table(query string) string {
