...
type CancelReservationParams struct {
	...
	// Body.
	Body models.OffersServiceCancelReservationBody
...
// WithBody adds the body to the cancel reservation params
func (o *CancelReservationParams) WithBody(body models.OffersServiceCancelReservationBody) *CancelReservationParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the cancel reservation params
func (o *CancelReservationParams) SetBody(body models.OffersServiceCancelReservationBody) {
	o.Body = body
}
