...
type CreateTicketParams struct {
	...
	// Body.
	Body *models.SupportpbCreateTicketRequest
...
func (o *CreateTicketParams) WithBody(body *models.SupportpbCreateTicketRequest) *CreateTicketParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create ticket params
func (o *CreateTicketParams) SetBody(body *models.SupportpbCreateTicketRequest) {
	o.Body = body
}
