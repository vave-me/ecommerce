...
type RemoveProductOK struct {
	Payload models.ProductspbRemoveProductResponse
}
...
func (o *RemoveProductOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/products/{id}][%d] removeProductOK %s", 200, payload)
}
...
func (o *RemoveProductOK) GetPayload() models.ProductspbRemoveProductResponse {
	return o.Payload
}
...
func (o *RemoveProductDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/products/{id}][%d] removeProduct default %s", o._statusCode, payload)
}
