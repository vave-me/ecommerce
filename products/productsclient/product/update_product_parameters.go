...
func (o *UpdateProductParams) WithBody(body *models.ProductsServiceUpdateProductBody) *UpdateProductParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update product params
func (o *UpdateProductParams) SetBody(body *models.ProductsServiceUpdateProductBody) {
	o.Body = body
}
