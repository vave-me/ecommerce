...
type AddProductOK struct {
	Payload *models.ProductspbAddProductResponse
}
...
func (o *AddProductOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/products][%d] addProductOK %s", 200, payload)
}
...
func (o *AddProductDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/products][%d] addProduct default %s", o._statusCode, payload)
}
