...
type RebrandProductOK struct {
	Payload models.ProductspbRebrandProductResponse
}
...
func (o *RebrandProductOK) Error() string {
	...
	return fmt.Sprintf("[PATCH /api/products/{id}/rebrand][%d] rebrandProductOK %s", 200, payload)
}
...
func (o *RebrandProductOK) GetPayload() models.ProductspbRebrandProductResponse {
	return o.Payload
}
...
func (o *RebrandProductDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /api/products/{id}/rebrand][%d] rebrandProduct default %s", o._statusCode, payload)
}
