...
type GetProductOK struct {
	Payload *models.ProductspbGetProductResponse
}
...
func (o *GetProductOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/products/{id}][%d] getProductOK %s", 200, payload)
}
...
func (o *GetProductDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/products/{id}][%d] getProduct default %s", o._statusCode, payload)
}
