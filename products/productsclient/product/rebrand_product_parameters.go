...
type RebrandProductParams struct {
	...
	// Body.
	Body *models.ProductsServiceRebrandProductBody
...
func (o *RebrandProductParams) WithBody(body *models.ProductsServiceRebrandProductBody) *RebrandProductParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the rebrand product params
func (o *RebrandProductParams) SetBody(body *models.ProductsServiceRebrandProductBody) {
	o.Body = body
}
