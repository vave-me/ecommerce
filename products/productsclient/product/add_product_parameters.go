...
type AddProductParams struct {
	...
	// Body.
	Body *models.ProductspbAddProductRequest
...
func (o *AddProductParams) WithBody(body *models.ProductspbAddProductRequest) *AddProductParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the add product params
func (o *AddProductParams) SetBody(body *models.ProductspbAddProductRequest) {
	o.Body = body
}
