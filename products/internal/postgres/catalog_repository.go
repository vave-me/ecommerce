...
func (r CatalogRepository) RebrandProduct(
	ctx context.Context,
	productID string,
	newName string,
...
// -----------------------------------------------------------------------------
// 3) UpdateProduct (now storing tags + attributes)
// -----------------------------------------------------------------------------
func (r CatalogRepository) UpdateProduct(
	...
	weight, height, width, depth int64, status domain.ProductStatus,
...
func (r CatalogRepository) GetProductsWithFilters(
	ctx context.Context,
	name string,
	categoryID string,
	categorySlug string,
...
) ([]*domain.CatalogProduct, int64, error) {
	...
	if err := r.db.QueryRowContext(ctx, countQuery, args...).Scan(&totalCount); err != nil {
		return nil, 0, errors.Wrap(err, "GetProductsWithFilters: counting total items")
	}
	...
	if err != nil {
		return nil, 0, errors.Wrap(err, "GetProductsWithFilters: query rows error")
	}
	defer rows.Close()

	var results []*domain.CatalogProduct
	for rows.Next() {
		cp := &domain.CatalogProduct{}
		var (
			tagsStr  string
			attrsStr string
			optsStr  string
		...
		if scErr != nil {
			return nil, 0, errors.Wrap(scErr, "GetProductsWithFilters scanning product row")
		}
	...
	if err = rows.Err(); err != nil {
		return nil, 0, errors.Wrap(err, "GetProductsWithFilters final iteration err")
	}
...
// 7) RemoveProduct
// -----------------------------------------------------------------------------
func (r CatalogRepository) RemoveProduct(
	ctx context.Context,
	productID string,
	userSellerID string,
) error {
...
// 8) MarkProductPawned
// -----------------------------------------------------------------------------
func (r CatalogRepository) MarkProductPawned(
	ctx context.Context,
	productID string,
	userSellerID string,
) error {
...
// 9) MarkProductLeased
// -----------------------------------------------------------------------------
func (r CatalogRepository) MarkProductLeased(
	ctx context.Context,
	productID string,
	userSellerID string,
) error {
...
// 10) MarkProductSold
// -----------------------------------------------------------------------------
func (r CatalogRepository) MarkProductSold(
	ctx context.Context,
	productID string,
	userSellerID string,
	finalPrice int64,
...
// 11) ArchiveProduct
// -----------------------------------------------------------------------------
func (r CatalogRepository) ArchiveProduct(
	ctx context.Context,
	productID string,
	userSellerID string,
) error {
...
func (r CatalogRepository) Find(ctx context.Context, productID string) (*domain.CatalogProduct, error) {
	...
	cp := &domain.CatalogProduct{ID: productID}
...
// 13) GetCatalog
// -----------------------------------------------------------------------------
func (r CatalogRepository) GetCatalog(ctx context.Context, userSellerID string, page, pageSize int64, sortBy, sortOrder string) ([]*domain.CatalogProduct, int64, error) {
...
// 13) GetCatalog
// -----------------------------------------------------------------------------
func (r CatalogRepository) GetPublicCatalog(ctx context.Context, userSellerID string, page, pageSize int64, sortBy, sortOrder string) ([]*domain.CatalogProduct, int64, error) {
	offset := (page - 1) * pageSize
	validSortFields := map[string]bool{
		"name":       true,
		"base_price": true,
...
func (r CatalogRepository) GetProducts(ctx context.Context, page, pageSize int64, sortBy, sortOrder string) ([]*domain.CatalogProduct, int64, error) {
	offset := (page - 1) * pageSize
	validSortFields := map[string]bool{
		"name":       true,
		"base_price": true,
	...
	if err != nil {
		return nil, 0, errors.Wrap(err, "querying all products")
	}
	defer rows.Close()
...
// -----------------------------------------------------------------------------
// 15) GetProductsByCategory
// -----------------------------------------------------------------------------
func (r CatalogRepository) GetProductsByCategory(ctx context.Context, categoryID string, page, pageSize int64, sortBy, sortOrder string) ([]*domain.CatalogProduct, int64, error) {
	offset := (page - 1) * pageSize
	validSortFields := map[string]bool{
		"name":       true,
		"base_price": true,
	...
	if err := r.db.QueryRowContext(ctx, countQ, categoryID).Scan(&totalCount); err != nil {
		return nil, 0, errors.Wrap(err, "counting products by category")
	}
	...
	if err != nil {
		return nil, 0, errors.Wrap(err, "querying products by category")
	}
	defer rows.Close()
...
func (r CatalogRepository) GetProductsByCategorySlug(ctx context.Context, categorySlug string, page, pageSize int64, sortBy, sortOrder string) ([]*domain.CatalogProduct, int64, error) {
	offset := (page - 1) * pageSize
	validSortFields := map[string]bool{
		"name":       true,
		"base_price": true,
...
func (r *CatalogRepository) FindByLocation(
	...
	// We SELECT all the columns you also retrieve in GetProducts or Find,
	...
	if err != nil {
		return nil, errors.Wrap(err, "querying products by location")
	}
	defer rows.Close()
...
func (r CatalogRepository) GetProductBySKU(ctx context.Context, sku string) (*domain.CatalogProduct, error) {
	query := fmt.Sprintf(`
		SELECT
			id,
			name,
...
func (r CatalogRepository) GetProductsBySKUs(ctx context.Context, skus []string) ([]*domain.CatalogProduct, error) {
	if len(skus) == 0 {
		return []*domain.CatalogProduct{}, nil
	}
	...
	if err != nil {
		return nil, errors.Wrap(err, "querying products by SKUs")
	}
	defer rows.Close()
