...
func (h GetProductsWithFiltersHandler) GetProductsWithFilters(ctx context.Context, query GetProductsWithFilters) ([]*domain.CatalogProduct, int64, error) {
	...
	return h.catalog.GetProductsWithFilters(ctx, query.Name, query.CategoryID, query.CategorySlug, query.MinPrice, query.MaxPrice, query.Brand, query.Condition, query.Model, query.Tags,
