...
import (
	...
	"middleman/products/internal/grpc"
	"middleman/products/internal/handlers"
	"middleman/products/internal/postgres"
	"middleman/products/internal/rest"
...
func registrations(reg registry.Registry) (err error) {
	...
	if err = serde.Register(domain.ProductUpdated{}); err != nil {
		return
	}
	if err = serde.Register(domain.ProductPriceIncreased{}); err != nil {
		return
	}
	if err = serde.Register(domain.ProductPriceDecreased{}); err != nil {
		return
	}
