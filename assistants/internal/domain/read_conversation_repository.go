...
type ReadConversationRepository interface {
	...
	GetAssistantConversations(ctx context.Context, assistantID string, limit, offset int) ([]*ReadConversation, int, error)
	...
	AddConversation(ctx context.Context, id, userID, assistantID string, createdAt time.Time, context map[string]interface{}) error
