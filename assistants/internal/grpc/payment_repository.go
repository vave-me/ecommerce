...
// AuthorizePaymentForCustomer authorizes a payment for the given amount and customer
func (r PaymentRepository) AuthorizePaymentForCustomer(ctx context.Context, userCustomerID string, amount int64) (*models.AuthorizePaymentResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
// ConfirmPaymentWithMethod confirms a previously authorized payment using a payment method ID
func (r PaymentRepository) ConfirmPaymentWithMethod(ctx context.Context, paymentID, paymentMethodID string) (*models.ConfirmPaymentResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
// CaptureAuthorizedPaymentAmount captures a payment, possibly partially
func (r PaymentRepository) CaptureAuthorizedPaymentAmount(ctx context.Context, paymentID string, amountToCapture int64) (*models.CapturePaymentResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
// CreateNewInvoiceForOrder creates a new invoice
func (r PaymentRepository) CreateNewInvoiceForOrder(ctx context.Context, orderID, paymentID string, amount int64) (*models.CreateInvoiceResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
// AdjustInvoiceAmountWithReason adjusts an existing invoice (e.g., changing the amount)
func (r PaymentRepository) AdjustInvoiceAmountWithReason(ctx context.Context, invoiceID string, amount int64, reason string) (*models.AdjustInvoiceResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
// PayInvoiceUsingPaymentMethod pays an existing invoice with the specified payment method
func (r PaymentRepository) PayInvoiceUsingPaymentMethod(ctx context.Context, invoiceID, paymentMethodID string) (*models.PayInvoiceResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
// CancelInvoiceWithReason cancels an existing invoice
func (r PaymentRepository) CancelInvoiceWithReason(ctx context.Context, invoiceID, reason string) error {
	conn, err := r.dial(ctx)
	if err != nil {
		return err
	}
...
// ProcessWebhookNotification handles a webhook event (e.g., from Stripe)
func (r PaymentRepository) ProcessWebhookNotification(ctx context.Context, rawBody, signature string) (*models.HandleWebhookResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
// GetPaymentDetailsByID retrieves a payment by ID (mock implementation for AI tooling)
func (r PaymentRepository) GetPaymentDetailsByID(ctx context.Context, paymentID string) (*models.Payment, error) {
...
// GetInvoiceDetailsByID retrieves an invoice by ID (mock implementation for AI tooling)
func (r PaymentRepository) GetInvoiceDetailsByID(ctx context.Context, invoiceID string) (*models.Invoice, error) {
...
// GetCustomerPaymentHistory retrieves payments by customer ID (mock implementation for AI tooling)
func (r PaymentRepository) GetCustomerPaymentHistory(ctx context.Context, userCustomerID string) ([]*models.Payment, error) {
...
// GetAllInvoicesForOrder retrieves invoices by order ID (mock implementation for AI tooling)
func (r PaymentRepository) GetAllInvoicesForOrder(ctx context.Context, orderID string) ([]*models.Invoice, error) {
...
// SearchPaymentsByStatus searches payments by status (mock implementation for AI tooling)
func (r PaymentRepository) SearchPaymentsByStatus(ctx context.Context, status string, limit int64) ([]*models.Payment, error) {
...
// SearchInvoicesByStatus searches invoices by status (mock implementation for AI tooling)
func (r PaymentRepository) SearchInvoicesByStatus(ctx context.Context, status string, limit int64) ([]*models.Invoice, error) {
