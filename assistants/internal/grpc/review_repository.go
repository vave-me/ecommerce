...
// CreateNewReview adds a review via the reviews microservice
func (r ReviewRepository) CreateNewReview(ctx context.Context, senderID, itemID, itemType, content, categoryID, parentID string) (string, error) {
...
// GetReviewByID retrieves a review by ID from the reviews microservice
...
// GetAllReviewsForItem retrieves all reviews for an item
func (r ReviewRepository) GetAllReviewsForItem(ctx context.Context, itemID string) ([]*models.Review, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
// EditReviewContent edits a review's content
func (r ReviewRepository) EditReviewContent(ctx context.Context, reviewID, content string) error {
	conn, err := r.dial(ctx)
	if err != nil {
		return err
	}
...
func (r ReviewRepository) DeleteReviewByID(ctx context.Context, reviewID string) error {
	conn, err := r.dial(ctx)
	if err != nil {
		return err
	}
...
// ApproveReviewByID approves a review
func (r ReviewRepository) ApproveReviewByID(ctx context.Context, reviewID string) (*models.Review, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
// RejectReviewByID rejects a review
func (r ReviewRepository) RejectReviewByID(ctx context.Context, reviewID string) (*models.Review, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
// FlagReviewAsInappropriate flags a review
func (r ReviewRepository) FlagReviewAsInappropriate(ctx context.Context, reviewID string) (*models.Review, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
// GetReviewsBySenderID retrieves all reviews by a sender
func (r ReviewRepository) GetReviewsBySenderID(ctx context.Context, senderID string) ([]*models.Review, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
// GetAllApprovedReviews retrieves all approved reviews
func (r ReviewRepository) GetAllApprovedReviews(ctx context.Context) ([]*models.Review, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
// GetMostReviewedItems retrieves items with the most reviews
func (r ReviewRepository) GetMostReviewedItems(ctx context.Context) ([]*models.ItemReviewCount, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
// GetMostReviewedItemsByCategory retrieves items with the most reviews in a category
func (r ReviewRepository) GetMostReviewedItemsByCategory(ctx context.Context, categoryID string, offset, limit int64) ([]*models.ItemReviewCount, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
// UpdateReviewContentByID updates the content of an existing review
func (r ReviewRepository) UpdateReviewContentByID(ctx context.Context, reviewID, content string) error {
	// For now, use the existing EditReviewContent method
	return r.EditReviewContent(ctx, reviewID, content)
}

// RemoveReviewPermanently deletes a review (alias for DeleteReviewByID)
func (r ReviewRepository) RemoveReviewPermanently(ctx context.Context, reviewID string) error {
	return r.DeleteReviewByID(ctx, reviewID)
}

// UnflagReviewByID removes the flag from a review
func (r ReviewRepository) UnflagReviewByID(ctx context.Context, reviewID string) error {
	// For now, return nil as this would need to be implemented in the reviews service
	// This is a placeholder implementation
	return nil
}

// SearchReviewsByKeyword searches for reviews based on a query
func (r ReviewRepository) SearchReviewsByKeyword(ctx context.Context, query string, limit int64) ([]*models.Review, error) {
	// For now, return empty results as this would need to be implemented in the reviews service
	// This is a placeholder implementation
	return []*models.Review{}, nil
}

// GetAllReviewsByItemID implements the missing interface method (legacy compatibility)
func (r ReviewRepository) GetAllReviewsByItemID(ctx context.Context, itemID string) ([]*models.Review, error) {
	return r.GetAllReviewsForItem(ctx, itemID)
}

// FindReviewByIDAndItem implements the missing interface method (legacy compatibility)
func (r ReviewRepository) FindReviewByIDAndItem(ctx context.Context, reviewID, itemID string) (*models.Review, error) {
	return r.GetReviewByID(ctx, reviewID)
}

// FindReviewsBySenderUserID implements the missing interface method (legacy compatibility)
func (r ReviewRepository) FindReviewsBySenderUserID(ctx context.Context, senderID string) ([]*models.Review, error) {
	return r.GetReviewsBySenderID(ctx, senderID)
}
