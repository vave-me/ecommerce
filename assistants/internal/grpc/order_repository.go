...
// CreateNewCustomerOrder creates a new order
func (r OrderRepository) CreateNewCustomerOrder(ctx context.Context, orderID string, items []models.Item, userCustomerID string) (*models.CreateOrderResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
func (r OrderRepository) GetOrderDetailsByID(ctx context.Context, orderID string) (*models.GetOrderResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
// CancelOrderWithReason cancels an existing order
func (r OrderRepository) CancelOrderWithReason(ctx context.Context, orderID, reason string) error {
	conn, err := r.dial(ctx)
	if err != nil {
		return err
	}
...
// MarkOrderAsReadyForProcessing marks an order as ready
func (r OrderRepository) MarkOrderAsReadyForProcessing(ctx context.Context, orderID string) (*models.ReadyOrderResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
// CompleteOrderWithInvoice completes an order
func (r OrderRepository) CompleteOrderWithInvoice(ctx context.Context, orderID, invoiceID string) (*models.CompleteOrderResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
// ApproveOrderForShopping approves an order
func (r OrderRepository) ApproveOrderForShopping(ctx context.Context, orderID, shoppingID string) (*models.ApproveOrderResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
// RejectOrderRequest rejects an order
func (r OrderRepository) RejectOrderRequest(ctx context.Context, orderID string) (*models.RejectOrderResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
// MarkOrderAsShipped ships an order
func (r OrderRepository) MarkOrderAsShipped(ctx context.Context, orderID string) (*models.ShipOrderResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
// MarkOrderAsDelivered delivers an order
func (r OrderRepository) MarkOrderAsDelivered(ctx context.Context, orderID string) (*models.DeliverOrderResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
// GetCustomerOrderHistory retrieves orders by customer ID (mock implementation for AI tooling)
func (r OrderRepository) GetCustomerOrderHistory(ctx context.Context, userCustomerID string) ([]*models.Order, error) {
...
// FilterOrdersByCurrentStatus retrieves orders by status (mock implementation for AI tooling)
func (r OrderRepository) FilterOrdersByCurrentStatus(ctx context.Context, status string, limit int64) ([]*models.Order, error) {
...
// SearchOrdersByKeyword searches orders by query (mock implementation for AI tooling)
func (r OrderRepository) SearchOrdersByKeyword(ctx context.Context, query string, limit int64) ([]*models.Order, error) {
...
// UpdateOrderInformation updates an existing order with the provided fields
func (r OrderRepository) UpdateOrderInformation(ctx context.Context, orderID string, updates map[string]interface{}) (*models.UpdateOrderResponse, error) {
