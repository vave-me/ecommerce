...
// CreateNewConversation starts a new conversation between a sender and a recipient regarding a specific item
func (r MessagesRepository) CreateNewConversation(ctx context.Context, senderID, recipientID, itemID string) (*models.ConversationResponse, error) {
...
// RestoreArchivedConversation restores an archived conversation by its unique identifier
func (r MessagesRepository) RestoreArchivedConversation(ctx context.Context, conversationID string) (*models.ConversationStatusResponse, error) {
	conn, err := r.dialWithAuth(ctx)
	if err != nil {
		return nil, err
	}
...
// ArchiveExistingConversation archives an active conversation by its unique identifier
func (r MessagesRepository) ArchiveExistingConversation(ctx context.Context, conversationID string) (*models.ConversationStatusResponse, error) {
	conn, err := r.dialWithAuth(ctx)
	if err != nil {
		return nil, err
	}
...
// GetConversationByID retrieves details of a specific conversation by its unique identifier
func (r MessagesRepository) GetConversationByID(ctx context.Context, conversationID string) (*models.Conversation, error) {
	conn, err := r.dialWithAuth(ctx)
	if err != nil {
		return nil, err
	}
...
// FindConversationByRecipientAndItem finds a conversation between users for a specific item
func (r MessagesRepository) FindConversationByRecipientAndItem(ctx context.Context, recipientID, itemID string) (*models.Conversation, error) {
	conn, err := r.dialWithAuth(ctx)
	if err != nil {
		return nil, err
	}
...
// GetUserConversationList retrieves a list of all conversations associated with a specific user
func (r MessagesRepository) GetUserConversationList(ctx context.Context, userID string, page, limit int64) (*models.ConversationsResponse, error) {
	conn, err := r.dialWithAuth(ctx)
	if err != nil {
		return nil, err
	}
...
// GetUserActiveConversations retrieves a list of active conversations for a specific user
func (r MessagesRepository) GetUserActiveConversations(ctx context.Context, userID string, page, limit int64) (*models.ConversationsResponse, error) {
	conn, err := r.dialWithAuth(ctx)
	if err != nil {
		return nil, err
	}
...
// SendNewMessage sends a message via the messages microservice
func (r MessagesRepository) SendNewMessage(ctx context.Context, messageID, conversationID, senderID, recipientID, itemID, body string, isRead bool) (*models.MessageSentResponse, error) {
	conn, err := r.dialWithAuth(ctx)
	if err != nil {
		return nil, err
	}
...
func (r MessagesRepository) DeleteMessageByID(ctx context.Context, messageID string) error {
	conn, err := r.dialWithAuth(ctx)
	if err != nil {
		return err
	}
...
// GetMessageByID retrieves a message by ID from the messages microservice
func (r MessagesRepository) GetMessageByID(ctx context.Context, messageID string) (*models.Message, error) {
	conn, err := r.dialWithAuth(ctx)
	if err != nil {
		return nil, err
	}
...
// GetConversationMessages retrieves a list of messages within a specific conversation
func (r MessagesRepository) GetConversationMessages(ctx context.Context, conversationID string, page, limit int64) (*models.MessagesResponse, error) {
	conn, err := r.dialWithAuth(ctx)
	if err != nil {
		return nil, err
	}
...
// MarkMessageAsReadByUser marks a message as read for a specific user
func (r MessagesRepository) MarkMessageAsReadByUser(ctx context.Context, messageID, userID string) error {
	// For now, return nil as this would need to be implemented in the messages service
	// This is a placeholder implementation
	return nil
}

// GetUserUnreadMessageCount returns the count of unread messages for a user
func (r MessagesRepository) GetUserUnreadMessageCount(ctx context.Context, userID string) (int64, error) {
