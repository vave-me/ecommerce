...
func (r BasketRepository) CreateNewBasket(ctx context.Context, userID string) (*models.StartBasketResponse, error) {
	log.Printf("[BASKET_GRPC] CreateNewBasket: starting basket for user=%s via gRPC", userID)

	conn, err := r.dialWithAuth(ctx)
	if err != nil {
		log.Printf("[BASKET_GRPC] CreateNewBasket: failed to dial gRPC: %v", err)
		return nil, err
	}
	defer conn.Close()
	...
	log.Printf("[BASKET_GRPC] CreateNewBasket: Mock implementation - would call basketspb.NewBasketServiceClient")
...
func (r BasketRepository) GetBasketByID(ctx context.Context, basketID string) (*models.GetBasketResponse, error) {
	log.Printf("[BASKET_GRPC] GetBasketByID: retrieving basket ID=%s via gRPC", basketID)
	...
	// Mock implementation
	log.Printf("[BASKET_GRPC] GetBasketByID: Mock implementation - would call basketspb.GetBasket")
...
func (r BasketRepository) CalculateBasketTotal(ctx context.Context, basketID string) (*models.GetTotalBasketAmountResponse, error) {
	log.Printf("[BASKET_GRPC] CalculateBasketTotal: getting total for basket ID=%s via gRPC", basketID)
	...
	// Mock implementation
	log.Printf("[BASKET_GRPC] CalculateBasketTotal: Mock implementation - would call basketspb.GetTotalBasket")
...
func (r BasketRepository) GetUserCurrentBasket(ctx context.Context, userCustomerID string) (*models.GetCurrentBasketResponse, error) {
...
func (r BasketRepository) CancelBasketWithReason(ctx context.Context, basketID, reason string) (*models.CancelBasketResponse, error) {
...
func (r BasketRepository) CheckoutUserBasket(ctx context.Context, basketID, userCustomerID string) (*models.CheckoutBasketResponse, error) {
...
func (r BasketRepository) AddProductToBasket(ctx context.Context, basketID, productID string, quantity int64) (*models.AddItemResponse, error) {
...
func (r BasketRepository) RemoveProductFromBasket(ctx context.Context, basketID, itemID string, quantity int64) (*models.RemoveItemResponse, error) {
...
func (r BasketRepository) UpdateBasketItemQuantity(ctx context.Context, basketID, itemID string, newQuantity int64) (*models.UpdateItemQuantityResponse, error) {
...
func (r BasketRepository) ListUserBaskets(ctx context.Context, userID, basketStatus string, page, limit int64) (*models.ListBasketsResponse, error) {
...
func (r BasketRepository) GetAllActiveBaskets(ctx context.Context) (*models.GetActiveBasketsResponse, error) {
...
func (r BasketRepository) GetBasketsPaginated(ctx context.Context, page, pageSize int64, sortBy, sortOrder string) ([]*models.Basket, error) {
	log.Printf("[BASKET_GRPC] GetBasketsWithPagination: Mock implementation")
	return []*models.Basket{}, nil
}

func (r BasketRepository) SearchBasketsByTerm(ctx context.Context, term string) ([]*models.Basket, error) {
	log.Printf("[BASKET_GRPC] SearchBasketsWithTerm: Mock implementation for term=%s", term)
	return []*models.Basket{}, nil
}

func (r BasketRepository) GetBasketsByStatusFilter(ctx context.Context, status string, page, pageSize int64) ([]*models.Basket, error) {
	log.Printf("[BASKET_GRPC] GetBasketsByStatus: Mock implementation for status=%s", status)
	return []*models.Basket{}, nil
}

func (r BasketRepository) GetAllUserBaskets(ctx context.Context, userID string, page, pageSize int64) ([]*models.Basket, error) {
	log.Printf("[BASKET_GRPC] GetUserBaskets: Mock implementation for user=%s", userID)
	return []*models.Basket{}, nil
}

func (r BasketRepository) GetUserBasketStatistics(ctx context.Context, userID string) (*models.BasketStatsResponse, error) {
...
func (r BasketRepository) GetExpiredBasketsToCleanup(ctx context.Context, page, pageSize int64) ([]*models.Basket, error) {
	log.Printf("[BASKET_GRPC] GetExpiredBaskets: Mock implementation")
	return []*models.Basket{}, nil
}

func (r BasketRepository) GetBasketsInDateRange(ctx context.Context, startDate, endDate string, page, pageSize int64) ([]*models.Basket, error) {
	log.Printf("[BASKET_GRPC] GetBasketsByDateRange: Mock implementation")
	return []*models.Basket{}, nil
}

func (r BasketRepository) GetAllBasketItems(ctx context.Context, basketID string) ([]*models.BasketItem, error) {
...
func (r BasketRepository) ClearAllBasketItems(ctx context.Context, basketID string) error {
	log.Printf("[BASKET_GRPC] ClearAllBasketItems: Mock implementation for basket=%s", basketID)
	return nil
}
...
func (r BasketRepository) FindBasketByID(ctx context.Context, basketID string) (*models.Basket, error) {
	log.Printf("[BASKET_GRPC] FindBasketByID: Mock implementation for basket=%s", basketID)
	return &models.Basket{
		ID:           basketID,
		UserID:       "mock_user",
		Items:        []*models.BasketItem{},
...
func (r BasketRepository) GetAbandonedBasketsToRecover(ctx context.Context, page, pageSize int64) ([]*models.Basket, error) {
	log.Printf("[BASKET_GRPC] GetAbandonedBasketsToRecover: Mock implementation")
	return []*models.Basket{}, nil
}

func (r BasketRepository) GetBasketConversionStatistics(ctx context.Context, dateRange string) (*models.BasketConversionStatsResponse, error) {
	log.Printf("[BASKET_GRPC] GetBasketConversionStatistics: Mock implementation")
	return &models.BasketConversionStatsResponse{
		Period:                dateRange,
		TotalBaskets:          0,
		CheckedOutBaskets:     0,
...
func (r BasketRepository) GetBasketItemCount(ctx context.Context, basketID string) (int64, error) {
	log.Printf("[BASKET_GRPC] GetBasketItemCount: Mock implementation for basket=%s", basketID)
	return 0, nil
}

func (r BasketRepository) GetUserBasketAnalytics(ctx context.Context, userID string, timeRange string) (*models.BasketAnalyticsResponse, error) {
	log.Printf("[BASKET_GRPC] GetUserBasketAnalytics: Mock implementation for user=%s", userID)
	return &models.BasketAnalyticsResponse{
		Period:            timeRange,
		TotalBaskets:      0,
		ConversionRate:    0.0,
...
func (r BasketRepository) GetUserBasketHistory(ctx context.Context, userID string) ([]*models.Basket, error) {
	log.Printf("[BASKET_GRPC] GetUserBasketHistory: Mock implementation for user=%s", userID)
	return []*models.Basket{}, nil
}

func (r BasketRepository) ValidateBasketContents(ctx context.Context, basketID string) (*models.BasketValidationResponse, error) {
	log.Printf("[BASKET_GRPC] ValidateBasketContents: Mock implementation for basket=%s", basketID)
	return &models.BasketValidationResponse{
		IsValid:     true,
		Errors:      []string{},
		Warnings:    []string{},
