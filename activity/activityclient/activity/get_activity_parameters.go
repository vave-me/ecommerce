...
// WithUserID adds the userID to the get activity params
func (o *GetActivityParams) WithUserID(userID string) *GetActivityParams {
	o.SetUserID(userID)
	return o
}

// SetUserID adds the userId to the get activity params
func (o *GetActivityParams) SetUserID(userID string) {
	o.UserID = userID
}
