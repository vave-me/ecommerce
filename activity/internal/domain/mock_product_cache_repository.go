...
// Add provides a mock function with given fields: ctx, productID, name, description, price, userSellerID, stock, sku, categoryID, active
func (_m *MockProductCacheRepository) Add(ctx context.Context, productID string, name string, description string, price int64, userSellerID string, stock int64, sku string, categoryID string, active string) error {
	ret := _m.Called(ctx, productID, name, description, price, userSellerID, stock, sku, categoryID, active)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string, int64, string, int64, string, string, string) error); ok {
		r0 = rf(ctx, productID, name, description, price, userSellerID, stock, sku, categoryID, active)
	} else {
		r0 = ret.Error(0)
	}
