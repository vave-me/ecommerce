...
// WithID adds the id to the get comment params
func (o *GetCommentParams) WithID(id string) *GetCommentParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get comment params
func (o *GetCommentParams) SetID(id string) {
	o.ID = id
}
