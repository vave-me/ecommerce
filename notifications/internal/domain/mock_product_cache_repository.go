...
// Add provides a mock function with given fields: ctx, productID, userSellerD, name, description, price
func (_m *MockProductCacheRepository) Add(ctx context.Context, productID string, userSellerD string, name string, description string, price int64) error {
	ret := _m.Called(ctx, productID, userSellerD, name, description, price)
	...
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string, string, int64) error); ok {
		r0 = rf(ctx, productID, userSellerD, name, description, price)
	} else {
		r0 = ret.Error(0)
	}
