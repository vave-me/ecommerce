...
import { NATSProvider, useNATS } from '../../context/NATSContext.jsx';
...
jest.mock('../../generated_proto/messages_service_api_pb.js', () => ({
  MessageType: {
    MESSAGE_TYPE_TEXT: 1,
    MESSAGE_TYPE_FILE: 2,
...
const setupConnectedState = () => {
  const natsModule = require('../../context/NATSContext.jsx');
