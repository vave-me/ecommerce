...
export namespace message_type {
    ...
    /** Represents a WebsocketMessageData. */
    class WebsocketMessageData implements IWebsocketMessageData {

        /**
         * Constructs a new WebsocketMessageData.
         * @param [properties] Properties to set
         */
        constructor(properties?: message_type.IWebsocketMessageData);
         ...
         * @param [properties] Properties to set
         * @returns WebsocketMessageData instance
         */
        public static create(properties?: message_type.IWebsocketMessageData): message_type.WebsocketMessageData;
         ...
         * @param message WebsocketMessageData message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encode(message: message_type.IWebsocketMessageData, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @returns Writer
         */
        public static encodeDelimited(message: message_type.IWebsocketMessageData, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
         * Decodes a WebsocketMessageData message from the specified reader or buffer.
         * @param reader Reader or buffer to decode from
         * @param [length] Message length if known beforehand
         * @returns WebsocketMessageData
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): message_type.WebsocketMessageData;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): message_type.WebsocketMessageData;
         ...
         * @returns WebsocketMessageData
         */
        public static fromObject(object: { [k: string]: any }): message_type.WebsocketMessageData;

        /**
         * Creates a plain object from a WebsocketMessageData message. Also converts values to other types if specified.
         * @param message WebsocketMessageData
         * @param [options] Conversion options
         * @returns Plain object
         */
        public static toObject(message: message_type.WebsocketMessageData, options?: $protobuf.IConversionOptions): { [k: string]: any };
