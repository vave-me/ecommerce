...
export async function generateMetadata(props) {
    ...
    try {
        ...
        return {
            ...
            alternates: {
                canonical: `https://www.sfx-market.de/${locale}/posts`,
            },
        };
    } catch (e) {
        // Fallback if translation fails
        return {
            title: "Posts & News", // Hardcoded fallback
            description: "Browse the latest posts and news.", // Hardcoded fallback
        };
    }
}
    ...
    try {
        ...
        const jsonLd = {
            ...
            itemListElement: serverPosts.map((p, i) => ({
                ...
                url: `https://www.sfx-market.de/${locale}/posts/${p.category?.slug || 'general'}/${p.slug || p.id}`, // Use dynamic URL
                ...
                item: {
                    ...
                    "mainEntityOfPage": {
                        "@type": "WebPage",
                        "@id": `https://www.sfx-market.de/${locale}/posts/${p.category?.slug || 'general'}/${p.slug || p.id}`
                    }
        ...
        let errorTitle = "Error Loading Posts";
        let errorMessage = "Could not load posts at this time. Please try again later.";
        try {
