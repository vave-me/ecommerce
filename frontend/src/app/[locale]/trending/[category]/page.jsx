...
import {getAllProducts} from '../../../../api/productsApi'; // Use appropriate API function
...
export default async function ProductsCategoryPage(props) {
    ...
    try {
        ...
        let fetchError = null;
        try {
            // Use an API function that accepts category filter, e.g., fetchProductsByFilters
            fetchedData = await fetchProductsByFilters(listingFilters); // Assuming API handles category
        } catch (err) {
             // Translated log
