...
const PostCard = ({post: postProp, locale = 'en'}) => {
    ...
    const post = useMemo(() => {
        ...
        // Weighted heat score for news/posts: engagement and shares are most important
        const viewWeight = views * 0.1;
        const likeWeight = likes * 3;
        const commentWeight = comments * 4;
        const bookmarkWeight = bookmarks * 5;
        const shareWeight = shares * 8; // Shares are very valuable for news
    ...
    const [flagged, setFlagged] = useState(post?.isFlagged || false);
