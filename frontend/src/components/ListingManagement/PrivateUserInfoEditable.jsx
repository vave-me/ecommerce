...
function PrivateUserInfoEditable({
                          sellerId,
...
PrivateUserInfoEditable.propTypes = {
...
PrivateUserInfoEditable.defaultProps = {
    user: {
        name: 'Unknown Seller',
...
export default PrivateUserInfoEditable;
/* --------------------------------------------
   STYLES (Compact)
--------------------------------------------- */
const colorBadgeSellerPrivateate = '#6C757D';
const colorBadgeSellerPrivate = '#2EA02E';
...
`;
/** Reused BaseBadge (both Privateate/Private) */
