...
jest.mock('../../generated_proto/message_types_pb', () => ({
  message_type: {
...
jest.mock('../../generated_proto/message_api_pb', () => ({
  jetstream: {
    StreamMessage: {
      create: jest.fn(obj => obj),
      decode: jest.fn()
...
describe('useChatHistory hook', () => {
  ...
  beforeEach(() => {
    ...
    require('../../generated_proto/message_api_pb').jetstream.StreamMessage.decode.mockImplementation(() => ({
      data: new Uint8Array([10, 11, 12])
    }));
    
    require('../../generated_proto/message_types_pb').message_type.WebsocketMessageData.decode.mockImplementation(() => ({
      payload: new Uint8Array([7, 8, 9])
    }));
    
    require('../../generated_proto/messages_api_events_pb').mes.SendMessage.decode.mockImplementation(() => ({
      id: 'msg-id-123',
      body: 'Hello world',
      senderId: 'sender-123',
