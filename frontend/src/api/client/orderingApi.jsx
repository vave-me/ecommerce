...
const ORDERING_API_BASE_URL = '/orders';
...
/**
 * Enhanced error handling for orders API
 */
const handleOrdersError = (error, endpoint, operation) => {
    const errorDetails = {
        success: false,
    ...
    if (error.response) {
        ...
        if (process.env.NODE_ENV === 'development') {
            // Orders API error logged for debugging
        }
...
export const createOrder = async (orderData) => {
    ...
    try {
        ...
        return handleOrdersError(error, endpoint, 'createOrder');
    }
};
...
export const getOrder = async (orderId) => {
    ...
    try {
        ...
        return handleOrdersError(error, endpoint, 'getOrder');
    }
};
...
export const cancelOrder = async (orderId, reason) => {
    ...
    try {
        ...
        return handleOrdersError(error, endpoint, 'cancelOrder');
    }
};
...
export const readyOrder = async (orderId) => {
    ...
    try {
        ...
        return handleOrdersError(error, endpoint, 'readyOrder');
    }
};
...
export const completeOrder = async (orderId, invoiceId) => {
    ...
    try {
        ...
        return handleOrdersError(error, endpoint, 'completeOrder');
    }
};
...
export const listOrders = async (params = {}) => {
    ...
    try {
        ...
        return handleOrdersError(error, endpoint, 'listOrders');
    }
};
...
export const getOrdersByCustomer = async (userCustomerId, params = {}) => {
    ...
    try {
        ...
        return handleOrdersError(error, endpoint, 'getOrdersByCustomer');
    }
};
...
export const getOrdersByStatus = async (status, params = {}) => {
    ...
    try {
        ...
        return handleOrdersError(error, endpoint, 'getOrdersByStatus');
    }
};
...
export const approveOrder = async (orderId, shoppingId) => {
    ...
    try {
        ...
        return handleOrdersError(error, endpoint, 'approveOrder');
    }
};
...
export const rejectOrder = async (orderId) => {
    ...
    try {
        ...
        return handleOrdersError(error, endpoint, 'rejectOrder');
    }
};
...
export const shipOrder = async (orderId) => {
    ...
    try {
        ...
        return handleOrdersError(error, endpoint, 'shipOrder');
    }
};
...
export const deliverOrder = async (orderId) => {
    ...
    try {
        ...
        return handleOrdersError(error, endpoint, 'deliverOrder');
    }
};
...
export const updateOrderStatus = async (orderId, status, reason) => {
    ...
    try {
        ...
        return handleOrdersError(error, endpoint, 'updateOrderStatus');
    }
};
