...
// WithBasketID adds the basketID to the add item params
func (o *AddItemParams) WithBasketID(basketID string) *AddItemParams {
	o.SetBasketID(basketID)
	return o
}

// SetBasketID adds the basketId to the add item params
func (o *AddItemParams) SetBasketID(basketID string) {
	o.BasketID = basketID
}
