...
func (o *RemoveItemOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/baskets/{basketId}/removeItem][%d] removeItemOK %s", 200, payload)
}
...
func (o *RemoveItemOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.BasketspbRemoveItemResponse)
...
func (o *RemoveItemDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/baskets/{basketId}/removeItem][%d] removeItem default %s", o._statusCode, payload)
}
