...
type ClientService interface {
	...
	UpdateItemQuantity(params *UpdateItemQuantityParams, opts ...ClientOption) (*UpdateItemQuantityOK, error)
...
func (a *Client) AddItem(params *AddItemParams, opts ...ClientOption) (*AddItemOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "addItem",
		Method:             "POST",
		PathPattern:        "/api/baskets/{basketId}/addItem",
...
func (a *Client) RemoveItem(params *RemoveItemParams, opts ...ClientOption) (*RemoveItemOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "removeItem",
		Method:             "DELETE",
		PathPattern:        "/api/baskets/{basketId}/removeItem",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
...
/*
UpdateItemQuantity updates item quantity in the basket
*/
func (a *Client) UpdateItemQuantity(params *UpdateItemQuantityParams, opts ...ClientOption) (*UpdateItemQuantityOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewUpdateItemQuantityParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "updateItemQuantity",
		Method:             "PATCH",
		PathPattern:        "/api/baskets/{basketId}/items/{itemId}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &UpdateItemQuantityReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
	...
	success, ok := result.(*UpdateItemQuantityOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*UpdateItemQuantityDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
