...
func (o *AddItemOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/baskets/{basketId}/addItem][%d] addItemOK %s", 200, payload)
}
...
func (o *AddItemOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.BasketspbAddItemResponse)
...
func (o *AddItemDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/baskets/{basketId}/addItem][%d] addItem default %s", o._statusCode, payload)
}
