...
func (o *CancelBasketOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/baskets/{basketId}][%d] cancelBasketOK %s", 200, payload)
}
...
func (o *CancelBasketDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/baskets/{basketId}][%d] cancelBasket default %s", o._statusCode, payload)
}
