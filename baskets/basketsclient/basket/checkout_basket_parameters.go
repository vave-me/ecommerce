...
type CheckoutBasketParams struct {
	...
	/* BasketID.
	   ...
	   Unique identifier of the basket to checkout.
	*/
	BasketID string
...
// WithBasketID adds the basketID to the checkout basket params
func (o *CheckoutBasketParams) WithBasketID(basketID string) *CheckoutBasketParams {
	o.SetBasketID(basketID)
	return o
}

// SetBasketID adds the basketId to the checkout basket params
func (o *CheckoutBasketParams) SetBasketID(basketID string) {
	o.BasketID = basketID
}
