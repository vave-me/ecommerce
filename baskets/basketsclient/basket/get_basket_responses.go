...
func (o *GetBasketOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/baskets/{basketId}][%d] getBasketOK %s", 200, payload)
}
...
func (o *GetBasketDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/baskets/{basketId}][%d] getBasket default %s", o._statusCode, payload)
}
