...
// WithBasketID adds the basketID to the get basket params
func (o *GetBasketParams) WithBasketID(basketID string) *GetBasketParams {
	o.SetBasketID(basketID)
	return o
}

// SetBasketID adds the basketId to the get basket params
func (o *GetBasketParams) SetBasketID(basketID string) {
	o.BasketID = basketID
}
