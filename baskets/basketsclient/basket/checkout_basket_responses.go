...
func (o *CheckoutBasketOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/baskets/{basketId}/checkout][%d] checkoutBasketOK %s", 200, payload)
}
...
func (o *CheckoutBasketOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.BasketspbCheckoutBasketResponse)
...
func (o *CheckoutBasketDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/baskets/{basketId}/checkout][%d] checkoutBasket default %s", o._statusCode, payload)
}
