...
type ReadMessagesRepository interface {
	...
	AddMessage(ctx context.Context, conversationID, managerID, id string, role MessageRole, content string, timestamp time.Time, metadata map[string]interface{}, ActionsTaken []ManagerAction) error
}
