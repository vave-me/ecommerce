...
func (r CommentRepository) AddComment(ctx context.Context, itemID, itemType, content, categoryID, parentID string) (*models.AddCommentResponse, error) {
	log.Printf("[COMMENT_GRPC] AddComment: adding comment for item=%s via gRPC", itemID)

	conn, err := r.dialWithAuth(ctx)
	if err != nil {
		log.Printf("[COMMENT_GRPC] AddComment: failed to dial gRPC: %v", err)
		return nil, err
	}
	defer conn.Close()
	...
	if err != nil {
		log.Printf("[COMMENT_GRPC] AddComment: RPC failed: %v", err)
...
func (r CommentRepository) ApproveComment(ctx context.Context, id string) (*models.ApproveCommentResponse, error) {
	log.Printf("[COMMENT_GRPC] ApproveComment: approving comment ID=%s via gRPC", id)
...
func (r CommentRepository) RejectComment(ctx context.Context, id string) (*models.RejectCommentResponse, error) {
	conn, err := r.dialWithAuth(ctx)
	if err != nil {
		return nil, err
	}
...
func (r CommentRepository) FlagComment(ctx context.Context, id string) (*models.FlagCommentResponse, error) {
	conn, err := r.dialWithAuth(ctx)
	if err != nil {
		return nil, err
	}
...
func (r CommentRepository) EditComment(ctx context.Context, id, content string) (*models.EditCommentResponse, error) {
	conn, err := r.dialWithAuth(ctx)
	if err != nil {
		return nil, err
	}
...
func (r CommentRepository) RemoveComment(ctx context.Context, id string) (*models.RemoveCommentResponse, error) {
	conn, err := r.dialWithAuth(ctx)
	if err != nil {
		return nil, err
	}
...
func (r CommentRepository) GetComment(ctx context.Context, id string) (*models.GetCommentResponse, error) {
	log.Printf("[COMMENT_GRPC] GetComment: retrieving comment ID=%s via gRPC", id)
...
func (r CommentRepository) GetComments(ctx context.Context, itemID string) (*models.GetCommentsResponse, error) {
	conn, err := r.dialWithAuth(ctx)
	if err != nil {
		return nil, err
	}
...
func (r CommentRepository) GetMostCommented(ctx context.Context) (*models.GetMostCommentedResponse, error) {
	conn, err := r.dialWithAuth(ctx)
	if err != nil {
		return nil, err
	}
...
func (r CommentRepository) GetMostCommentedByCategory(ctx context.Context, categoryID string, offset, limit int64) (*models.GetMostCommentedByCategoryResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
func (r CommentRepository) GetCommentsBySender(ctx context.Context) (*models.GetCommentsBySenderResponse, error) {
	conn, err := r.dialWithAuth(ctx)
	if err != nil {
		return nil, err
	}
...
func (r CommentRepository) GetApprovedComments(ctx context.Context) (*models.GetApprovedCommentsResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
func (r CommentRepository) GetCommentsWithPagination(ctx context.Context, page, pageSize int64, sortBy, sortOrder string) ([]*models.Comment, error) {
...
func (r CommentRepository) SearchCommentsWithTerm(ctx context.Context, term string) ([]*models.Comment, error) {
	// This would require additional RPC method
	return nil, fmt.Errorf("SearchCommentsWithTerm not implemented - requires additional RPC method")
}

func (r CommentRepository) GetCommentsByStatus(ctx context.Context, status string, page, pageSize int64) ([]*models.Comment, error) {
	// This would require additional RPC method
	return nil, fmt.Errorf("GetCommentsByStatus not implemented - requires additional RPC method")
}

func (r CommentRepository) GetCommentsByCategory(ctx context.Context, categoryID string, page, pageSize int64) ([]*models.Comment, error) {
	// This would require additional RPC method
	return nil, fmt.Errorf("GetCommentsByCategory not implemented - requires additional RPC method")
}

func (r CommentRepository) GetCommentStats(ctx context.Context, itemID string) (*models.CommentStatsResponse, error) {
	// This would require additional RPC method
	return nil, fmt.Errorf("GetCommentStats not implemented - requires additional RPC method")
}

func (r CommentRepository) GetRecentComments(ctx context.Context, page, pageSize int64) ([]*models.Comment, error) {
	// This would require additional RPC method
	return nil, fmt.Errorf("GetRecentComments not implemented - requires additional RPC method")
}

func (r CommentRepository) GetCommentThread(ctx context.Context, parentID string) ([]*models.Comment, error) {
	// This would require additional RPC method
...
func (r CommentRepository) FindComment(ctx context.Context, commentID, itemID string) (*models.Comment, error) {
	resp, err := r.GetComment(ctx, commentID)
	if err != nil {
		return nil, err
	}
...
func (r CommentRepository) AllCommentsByItemID(ctx context.Context, itemID string) ([]*models.Comment, error) {
	resp, err := r.GetComments(ctx, itemID)
	if err != nil {
		return nil, err
	}
...
func (r CommentRepository) FindAllCommentBySenderID(ctx context.Context) ([]*models.Comment, error) {
	resp, err := r.GetCommentsBySender(ctx)
	if err != nil {
		return nil, err
	}
	return resp.Comments, nil
