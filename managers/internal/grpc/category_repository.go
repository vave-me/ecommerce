...
func (r CategoryRepository) AddCategory(ctx context.Context, req *models.AddCategoryRequest) (*models.AddCategoryResponse, error) {
...
func (r CategoryRepository) GetCategory(ctx context.Context, id, lang, userID string) (*models.GetCategoryResponse, error) {
...
func (r CategoryRepository) GetCategoryBySlug(ctx context.Context, slug, lang, userID string) (*models.GetCategoryBySlugResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
func (r CategoryRepository) GetCategories(ctx context.Context, page int64, lang, categoryType string, pageSize int64, sortBy, sortOrder string) (*models.GetCategoriesResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
	...
	client := categoriespb.NewCategoriesServiceClient(conn)
	resp, err := client.GetCategories(ctx, &categoriespb.GetCategoriesRequest{
		Page:         page,
		Lang:         lang,
...
func (r CategoryRepository) GetMainCategories(ctx context.Context, page int64, lang, categoryType string, pageSize int64, sortBy, sortOrder string) (*models.GetMainCategoriesResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
func (r CategoryRepository) GetAllMainCategories(ctx context.Context, page int64, lang string, pageSize int64, sortBy, sortOrder string) (*models.GetAllMainCategoriesResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
func (r CategoryRepository) GetSubCategories(ctx context.Context, parentCategoryID, lang string, page, pageSize int64, sortBy, sortOrder string) (*models.GetSubCategoriesResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
func (r CategoryRepository) RemoveCategory(ctx context.Context, id, userID string) (*models.RemoveCategoryResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
func (r CategoryRepository) RebrandCategory(ctx context.Context, req *models.RebrandCategoryRequest) (*models.RebrandCategoryResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
func (r CategoryRepository) UpdateCategory(ctx context.Context, req *models.UpdateCategoryRequest) (*models.UpdateCategoryResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
func (r CategoryRepository) ArchiveCategory(ctx context.Context, id, userID string) (*models.ArchiveCategoryResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
func (r CategoryRepository) AddFilter(ctx context.Context, req *models.AddFilterRequest) (*models.AddFilterResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
func (r CategoryRepository) GetFilter(ctx context.Context, filterID, userID string) (*models.GetFilterResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
func (r CategoryRepository) GetFilters(ctx context.Context, categoryID string, page, pageSize int64, sortBy, sortOrder, userID string) (*models.GetFiltersResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
func (r CategoryRepository) ArchiveFilter(ctx context.Context, filterID, userID string) (*models.ArchiveFilterResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
func (r CategoryRepository) RemoveFilter(ctx context.Context, filterID, userID string) (*models.RemoveFilterResponse, error) {
	conn, err := r.dial(ctx)
	if err != nil {
		return nil, err
	}
...
func (r CategoryRepository) GetCategoriesWithPagination(ctx context.Context, page, pageSize int64, sortBy, sortOrder string) ([]*models.Category, error) {
	resp, err := r.GetCategories(ctx, page, "", "", pageSize, sortBy, sortOrder)
	if err != nil {
		return nil, err
	}
...
func (r CategoryRepository) SearchCategoriesWithTerm(ctx context.Context, term string) ([]*models.Category, error) {
	log.Printf("SearchCategoriesWithTerm called with term: %s (mock implementation)", term)
	return []*models.Category{}, nil
}

func (r CategoryRepository) GetCategoriesByType(ctx context.Context, categoryType string, page, pageSize int64) ([]*models.Category, error) {
	resp, err := r.GetCategories(ctx, page, "", categoryType, pageSize, "", "")
	if err != nil {
		return nil, err
	}
	return resp.Categories, nil
...
func (r CategoryRepository) GetActiveCategories(ctx context.Context, lang string, page, pageSize int64) ([]*models.Category, error) {
	resp, err := r.GetCategories(ctx, page, lang, "", pageSize, "", "")
	if err != nil {
		return nil, err
	}
...
func (r CategoryRepository) GetCategoryStats(ctx context.Context, categoryID string) (*models.CategoryStatsResponse, error) {
...
func (r CategoryRepository) GetFiltersByCategory(ctx context.Context, categoryID string) ([]*models.Filter, error) {
	resp, err := r.GetFilters(ctx, categoryID, 1, 100, "", "", "")
	if err != nil {
		return nil, err
	}
...
func (r CategoryRepository) GetCategoriesByParent(ctx context.Context, parentID string, page, pageSize int64) ([]*models.Category, error) {
	resp, err := r.GetSubCategories(ctx, parentID, "", page, pageSize, "", "")
	if err != nil {
		return nil, err
	}
	return resp.Categories, nil
...
func (r CategoryRepository) SearchFiltersWithTerm(ctx context.Context, term string) ([]*models.Filter, error) {
	log.Printf("SearchFiltersWithTerm called with term: %s (mock implementation)", term)
	return []*models.Filter{}, nil
}

func (r CategoryRepository) GetTopCategories(ctx context.Context, limit int64) ([]*models.Category, error) {
	resp, err := r.GetCategories(ctx, 1, "", "", limit, "view_count", "desc")
	if err != nil {
		return nil, err
	}
	return resp.Categories, nil
...
func (r CategoryRepository) GetCategoryHierarchy(ctx context.Context, categoryID string) (*models.CategoryHierarchyResponse, error) {
...
func (r CategoryRepository) FindCategory(ctx context.Context, categoryID string) (*models.Category, error) {
	resp, err := r.GetCategory(ctx, categoryID, "", "")
	if err != nil {
		return nil, err
	}
	return resp.Category, nil
...
func (r CategoryRepository) GetCategoryFilters(ctx context.Context, categoryID string) ([]*models.Filter, error) {
	return r.GetFiltersByCategory(ctx, categoryID)
}
