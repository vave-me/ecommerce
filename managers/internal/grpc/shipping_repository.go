...
func (r ShippingRepository) CreateShipping(ctx context.Context, productID, trackingNumber, labelURL, senderName, senderAddress, receiverName, receiverAddress, weight, dimensions, serviceTypes string) (*models.CreateShippingResponse, error) {
...
// TrackShipping tracks a shipment by tracking number
func (r ShippingRepository) TrackShipping(ctx context.Context, trackingNumber string) (*models.TrackShippingResponse, error) {
	var conn *grpc.ClientConn
	conn, err := r.dial(ctx)
