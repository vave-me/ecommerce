...
// AddFollow creates a new follow relationship
func (r FollowingRepository) AddFollow(ctx context.Context, userID, followedUserID, followedUserType, content, categoryID, parentID string) (*models.AddFollowResponse, error) {
	log.Printf("[FOLLOWING_GRPC] AddFollow called for userID=%s, followedUserID=%s", userID, followedUserID)
	...
	if err != nil {
		log.Printf("[FOLLOWING_GRPC] AddFollow RPC failed: %v", err)
		return nil, fmt.Errorf("AddFollow RPC failed: %w", err)
	}

	log.Printf("[FOLLOWING_GRPC] AddFollow RPC successful, created follow with ID: %s", resp.GetId())
	return &models.AddFollowResponse{
		ID: resp.GetId(),
	}, nil
}

// ApproveFollow approves a follow request
func (r FollowingRepository) ApproveFollow(ctx context.Context, id string) (*models.ApproveFollowResponse, error) {
...
func (r FollowingRepository) RejectFollow(ctx context.Context, id string) (*models.RejectFollowResponse, error) {
...
// FlagFollow flags a follow for review
func (r FollowingRepository) FlagFollow(ctx context.Context, id string) (*models.FlagFollowResponse, error) {
...
// EditFollow edits the content of a follow
func (r FollowingRepository) EditFollow(ctx context.Context, id, content string) (*models.EditFollowResponse, error) {
...
func (r FollowingRepository) RemoveFollow(ctx context.Context, id string) (*models.RemoveFollowResponse, error) {
...
// GetFollow retrieves a specific follow by ID
func (r FollowingRepository) GetFollow(ctx context.Context, id string) (*models.GetFollowResponse, error) {
...
// GetFollowing retrieves all followers for a user
func (r FollowingRepository) GetFollowing(ctx context.Context, followedUserID string) (*models.GetFollowingResponse, error) {
...
// GetMostFollowed retrieves the most followed items
func (r FollowingRepository) GetMostFollowed(ctx context.Context) (*models.GetMostFollowedResponse, error) {
...
// GetMostFollowedByCategory retrieves the most followed items in a category
func (r FollowingRepository) GetMostFollowedByCategory(ctx context.Context, categoryID string, offset, limit int64) (*models.GetMostFollowedByCategoryResponse, error) {
...
// GetFollowingBySender retrieves all follows by a specific sender
func (r FollowingRepository) GetFollowingBySender(ctx context.Context, userID string) (*models.GetFollowingBySenderResponse, error) {
...
// GetApprovedFollowing retrieves all approved follows
func (r FollowingRepository) GetApprovedFollowing(ctx context.Context) (*models.GetApprovedFollowingResponse, error) {
...
func (r FollowingRepository) GetFollowsWithPagination(ctx context.Context, page, pageSize int64, sortBy, sortOrder string) ([]*models.Follow, error) {
	return nil, fmt.Errorf("GetFollowsWithPagination not implemented - requires additional RPC method in protobuf")
}

func (r FollowingRepository) SearchFollowsWithTerm(ctx context.Context, term string) ([]*models.Follow, error) {
	return nil, fmt.Errorf("SearchFollowsWithTerm not implemented - requires additional RPC method in protobuf")
}

func (r FollowingRepository) GetUserFollowingHistory(ctx context.Context, userID string, page, pageSize int64) ([]*models.Follow, error) {
	return nil, fmt.Errorf("GetUserFollowingHistory not implemented - requires additional RPC method in protobuf")
}

func (r FollowingRepository) GetFollowsByStatus(ctx context.Context, status string, page, pageSize int64) ([]*models.Follow, error) {
	return nil, fmt.Errorf("GetFollowsByStatus not implemented - requires additional RPC method in protobuf")
}

func (r FollowingRepository) GetFollowingStats(ctx context.Context, userID string) (*models.FollowingStatsResponse, error) {
	return nil, fmt.Errorf("GetFollowingStats not implemented - requires additional RPC method in protobuf")
}

func (r FollowingRepository) GetMutualFollowing(ctx context.Context, userID1, userID2 string) ([]*models.Follow, error) {
	return nil, fmt.Errorf("GetMutualFollowing not implemented - requires additional RPC method in protobuf")
}

func (r FollowingRepository) GetFollowingByCategory(ctx context.Context, categoryID string, page, pageSize int64) ([]*models.Follow, error) {
	return nil, fmt.Errorf("GetFollowingByCategory not implemented - requires additional RPC method in protobuf")
}

// Legacy methods for backward compatibility
func (r FollowingRepository) FollowUser(ctx context.Context, followID, userID, followedUserID string, followedUserType models.UserType, content, categoryID, parentID string) error {
	_, err := r.AddFollow(ctx, userID, followedUserID, followedUserType.String(), content, categoryID, parentID)
	return err
}

func (r FollowingRepository) FindFollow(ctx context.Context, followID, followedUserID string) (*models.Follow, error) {
	resp, err := r.GetFollow(ctx, followID)
	if err != nil {
		return nil, err
	}
...
func (r FollowingRepository) AllFollowers(ctx context.Context, followedUserID string) ([]*models.Follow, error) {
	resp, err := r.GetFollowing(ctx, followedUserID)
	if err != nil {
		return nil, err
	}
...
func (r FollowingRepository) FindByUserID(ctx context.Context, userID string) ([]*models.Follow, error) {
	resp, err := r.GetFollowingBySender(ctx, userID)
	if err != nil {
		return nil, err
	}
	return resp.Following, nil
...
func (r FollowingRepository) UnfollowUser(ctx context.Context, followID string) error {
	log.Printf("[FOLLOWING_GRPC] UnfollowUser called for followID: %s", followID)
	// Implementation would call the unfollow RPC
	return nil
}

// GetFollowerCount gets the count of followers for a user
func (r FollowingRepository) GetFollowerCount(ctx context.Context, userID string) (int, error) {
	log.Printf("[FOLLOWING_GRPC] GetFollowerCount called for userID: %s", userID)

	// TODO: Implement when gRPC method is available
	// For now, return a placeholder count
	log.Printf("[FOLLOWING_GRPC] GetFollowerCount placeholder implementation for userID: %s", userID)
	return 0, nil
}

// GetFollowers gets the followers for a user
func (r FollowingRepository) GetFollowers(ctx context.Context, userID string, limit int32) ([]*models.Follow, error) {
	log.Printf("[FOLLOWING_GRPC] GetFollowers called for userID: %s, limit: %d", userID, limit)

	// TODO: Implement when gRPC method is available
	// For now, return an empty slice
	log.Printf("[FOLLOWING_GRPC] GetFollowers placeholder implementation for userID: %s", userID)
	return []*models.Follow{}, nil
}

// GetFollowingCount gets the count of users being followed by a user
func (r FollowingRepository) GetFollowingCount(ctx context.Context, userID string) (int, error) {
	log.Printf("[FOLLOWING_GRPC] GetFollowingCount called for userID: %s", userID)

	// TODO: Implement when gRPC method is available
	// For now, return a placeholder count
	log.Printf("[FOLLOWING_GRPC] GetFollowingCount placeholder implementation for userID: %s", userID)
	return 0, nil
}

// IsFollowing checks if a user is following another user
func (r FollowingRepository) IsFollowing(ctx context.Context, userID, followedUserID string) (bool, error) {
	log.Printf("[FOLLOWING_GRPC] IsFollowing called for userID: %s, followedUserID: %s", userID, followedUserID)

	// TODO: Implement when gRPC method is available
	// For now, return false
	log.Printf("[FOLLOWING_GRPC] IsFollowing placeholder implementation for userID: %s, followedUserID: %s", userID, followedUserID)
	return false, nil
}
