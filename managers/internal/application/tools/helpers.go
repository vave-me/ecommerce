...
// ToolStreamingConfig represents streaming configuration for tools
type ToolStreamingConfig struct {
	StreamBufferSize  int           `json:"stream_buffer_size"`
	StreamTimeout     time.Duration `json:"stream_timeout"`
	HeartbeatInterval time.Duration `json:"heartbeat_interval"`
}

// DefaultToolStreamingConfig returns default streaming configuration for tools
func DefaultToolStreamingConfig() *ToolStreamingConfig {
