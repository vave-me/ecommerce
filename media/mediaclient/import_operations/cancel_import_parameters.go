...
type CancelImportParams struct {
	...
	// Body.
	Body *models.MediaServiceCancelImportBody
...
// WithBody adds the body to the cancel import params
func (o *CancelImportParams) WithBody(body *models.MediaServiceCancelImportBody) *CancelImportParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the cancel import params
func (o *CancelImportParams) SetBody(body *models.MediaServiceCancelImportBody) {
	o.Body = body
}

// WithSessionID adds the sessionID to the cancel import params
func (o *CancelImportParams) WithSessionID(sessionID string) *CancelImportParams {
	o.SetSessionID(sessionID)
	return o
}

// SetSessionID adds the sessionId to the cancel import params
func (o *CancelImportParams) SetSessionID(sessionID string) {
