...
func (o *GetProductsParams) WithPage(page *string) *GetProductsParams {
	o.SetPage(page)
	return o
}

// SetPage adds the page to the get products params
func (o *GetProductsParams) SetPage(page *string) {
	o.Page = page
}

// WithPageSize adds the pageSize to the get products params
func (o *GetProductsParams) WithPageSize(pageSize *string) *GetProductsParams {
	o.SetPageSize(pageSize)
	return o
}

// SetPageSize adds the pageSize to the get products params
func (o *GetProductsParams) SetPageSize(pageSize *string) {
	o.PageSize = pageSize
}

// WithSortBy adds the sortBy to the get products params
func (o *GetProductsParams) WithSortBy(sortBy *string) *GetProductsParams {
	o.SetSortBy(sortBy)
	return o
}

// SetSortBy adds the sortBy to the get products params
func (o *GetProductsParams) SetSortBy(sortBy *string) {
	o.SortBy = sortBy
}

// WithSortOrder adds the sortOrder to the get products params
func (o *GetProductsParams) WithSortOrder(sortOrder *string) *GetProductsParams {
	o.SetSortOrder(sortOrder)
	return o
}

// SetSortOrder adds the sortOrder to the get products params
func (o *GetProductsParams) SetSortOrder(sortOrder *string) {
