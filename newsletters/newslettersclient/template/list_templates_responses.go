...
type ListTemplatesOK struct {
	Payload *models.NewsletterspbListTemplatesResponse
}
...
func (o *ListTemplatesOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/templates][%d] listTemplatesOK %s", 200, payload)
}
...
func (o *ListTemplatesOK) GetPayload() *models.NewsletterspbListTemplatesResponse {
	return o.Payload
}
...
func (o *ListTemplatesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.NewsletterspbListTemplatesResponse)
...
func (o *ListTemplatesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/templates][%d] listTemplates default %s", o._statusCode, payload)
}
...
func (o *ListTemplatesDefault) GetPayload() *models.RPCStatus {
	return o.Payload
}
