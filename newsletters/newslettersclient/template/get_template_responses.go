...
type GetTemplateOK struct {
	Payload *models.NewsletterspbGetTemplateResponse
}
...
func (o *GetTemplateOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/templates/{id}][%d] getTemplateOK %s", 200, payload)
}
...
func (o *GetTemplateOK) GetPayload() *models.NewsletterspbGetTemplateResponse {
	return o.Payload
}
...
func (o *GetTemplateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.NewsletterspbGetTemplateResponse)
...
func (o *GetTemplateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/templates/{id}][%d] getTemplate default %s", o._statusCode, payload)
}
...
func (o *GetTemplateDefault) GetPayload() *models.RPCStatus {
	return o.Payload
}
