...
type UpdateTemplateParams struct {
	...
	// Body.
	Body *models.NewslettersServiceUpdateTemplateBody
...
func (o *UpdateTemplateParams) WithBody(body *models.NewslettersServiceUpdateTemplateBody) *UpdateTemplateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update template params
func (o *UpdateTemplateParams) SetBody(body *models.NewslettersServiceUpdateTemplateBody) {
	o.Body = body
}

// WithID adds the id to the update template params
func (o *UpdateTemplateParams) WithID(id string) *UpdateTemplateParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the update template params
func (o *UpdateTemplateParams) SetID(id string) {
	o.ID = id
}
