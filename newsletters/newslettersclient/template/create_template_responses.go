...
type CreateTemplateOK struct {
	Payload *models.NewsletterspbCreateTemplateResponse
}
...
func (o *CreateTemplateOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/templates][%d] createTemplateOK %s", 200, payload)
}
...
func (o *CreateTemplateOK) GetPayload() *models.NewsletterspbCreateTemplateResponse {
	return o.Payload
}
...
func (o *CreateTemplateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.NewsletterspbCreateTemplateResponse)
...
func (o *CreateTemplateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/templates][%d] createTemplate default %s", o._statusCode, payload)
}
...
func (o *CreateTemplateDefault) GetPayload() *models.RPCStatus {
	return o.Payload
}
