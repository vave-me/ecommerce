...
type CreateTemplateParams struct {
	...
	// Body.
	Body *models.NewsletterspbCreateTemplateRequest
...
func (o *CreateTemplateParams) WithBody(body *models.NewsletterspbCreateTemplateRequest) *CreateTemplateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create template params
func (o *CreateTemplateParams) SetBody(body *models.NewsletterspbCreateTemplateRequest) {
	o.Body = body
}
