...
type SubscribeOK struct {
	Payload *models.NewsletterspbSubscribeResponse
}
...
func (o *SubscribeOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/subscriptions][%d] subscribeOK %s", 200, payload)
}
...
func (o *SubscribeDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/subscriptions][%d] subscribe default %s", o._statusCode, payload)
}
