...
type SubscribeParams struct {
	...
	// Body.
	Body *models.NewsletterspbSubscribeRequest
...
func (o *SubscribeParams) WithBody(body *models.NewsletterspbSubscribeRequest) *SubscribeParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the subscribe params
func (o *SubscribeParams) SetBody(body *models.NewsletterspbSubscribeRequest) {
	o.Body = body
}
