...
type UpdateSubscriptionParams struct {
	...
	// Body.
	Body *models.NewslettersServiceUpdateSubscriptionBody
...
func (o *UpdateSubscriptionParams) WithBody(body *models.NewslettersServiceUpdateSubscriptionBody) *UpdateSubscriptionParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update subscription params
func (o *UpdateSubscriptionParams) SetBody(body *models.NewslettersServiceUpdateSubscriptionBody) {
	o.Body = body
}
