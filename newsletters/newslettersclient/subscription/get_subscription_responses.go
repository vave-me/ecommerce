...
type GetSubscriptionOK struct {
	Payload *models.NewsletterspbGetSubscriptionResponse
}
...
func (o *GetSubscriptionOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/subscriptions/{id}][%d] getSubscriptionOK %s", 200, payload)
}
...
func (o *GetSubscriptionOK) GetPayload() *models.NewsletterspbGetSubscriptionResponse {
	return o.Payload
}
...
func (o *GetSubscriptionOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.NewsletterspbGetSubscriptionResponse)
...
func (o *GetSubscriptionDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/subscriptions/{id}][%d] getSubscription default %s", o._statusCode, payload)
}
...
func (o *GetSubscriptionDefault) GetPayload() *models.RPCStatus {
	return o.Payload
}
