...
type VectorsConfig struct {
	...
	QdrantHost           string `envconfig:"QDRANT_HOST"`
	QdrantPort           string `envconfig:"QDRANT_PORT"`
}

// LoadMediaConfig loads configuration for the Media service from environment variables
func LoadVectorsConfig() *VectorsConfig {
...
func InitVectorsConfig() (assistantsConfig VectorsConfig, err error) {
	...
	err = envconfig.Process("", &assistantsConfig)
	return
}
