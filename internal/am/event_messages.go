...
func NewEventPublisher(reg registry.Registry, msgPublisher MessagePublisher, logger zerolog.Logger, mws ...MessagePublisherMiddleware) EventPublisher {
...
func NewEventHandler(reg registry.Registry, handler ddd.EventHandler[ddd.Event], logger zerolog.Logger, mws ...MessageHandlerMiddleware) MessageHandler {
