...
// CapturePayment provides a mock function with given fields: _a0, _a1
func (_m *MockPaymentsServiceServer) CapturePayment(_a0 context.Context, _a1 *CapturePaymentRequest) (*CapturePaymentResponse, error) {
	ret := _m.Called(_a0, _a1)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *CapturePaymentRequest) (*CapturePaymentResponse, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *CapturePaymentRequest) *CapturePaymentResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *CapturePaymentRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
// HandleWebhook provides a mock function with given fields: _a0, _a1
func (_m *MockPaymentsServiceServer) HandleWebhook(_a0 context.Context, _a1 *HandleWebhookRequest) (*HandleWebhookResponse, error) {
	ret := _m.Called(_a0, _a1)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *HandleWebhookRequest) (*HandleWebhookResponse, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *HandleWebhookRequest) *HandleWebhookResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *HandleWebhookRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
