...
// ProductClient calls the remote products service (gRPC) as a fallback.
type ProductClient struct {
	endpoint string
	auth     *auth.Auth // Optional auth for authenticated calls
}

// ProductClient is a gRPC client for the products service

// NewProductClient creates a new ProductClient with JWT authentication support
func NewProductClient(endpoint string, authInstance *auth.Auth) ProductClient {
...
func (r ProductClient) Rebrand(ctx context.Context, productID, name, description string, basePrice int64, stock int64, sku string, categoryID string, status string) error {
...
func (r ProductClient) SearchWithTerm(ctx context.Context, name string) ([]*domain.Product, error) {
...
func (r ProductClient) SuggestProducts(ctx context.Context, name string) ([]*domain.Product, error) {
	// Use SearchWithTerm as a fallback for suggestions
	return r.SearchWithTerm(ctx, name)
}

func (r ProductClient) UpdateThumbnail(ctx context.Context, productID string, thumbnail string) error {
...
func (r ProductClient) SearchWithFilters(
	ctx context.Context,
	name string,
	categoryId string,
	categorySlug string,
...
// SearchWithFilters calls the remote microservice's GetProductsWithFilters (or similar).
func (r ProductClient) SearchProductsWithCategorySlug(
	ctx context.Context,
	categorySlug string,
	page, pageSize int64,
	sortBy, sortOrder string,
...
// SearchWithFilters calls the remote microservice's GetProductsWithFilters (or similar).
func (r ProductClient) SearchProductsWithCategory(
	ctx context.Context,
	categoryId string,
	page, pageSize int64,
	sortBy, sortOrder string,
...
func (r ProductClient) Add(ctx context.Context, productID string, name string, description string, basePrice int64, userSellerID string, categoryID string, categorySlug string, brand string, condition string, model string, tags []string, manageStock bool, stock int64, sku string, attributes []domain.Attribute, weight int64, height int64, width int64, depth int64, status string, negotiable bool, userType string, middlemanService bool, shippingCost int64, hasVariants bool, options []domain.Option, lat float64, lng float64, thumbnail string, entityType domain.EntityType) error {
...
func (r ProductClient) Update(ctx context.Context, productID string, price int64) error {
	conn, err := r.dialWithAuth(ctx)
	if err != nil {
		return err
	}
...
func (r ProductClient) Remove(ctx context.Context, productID string) error {
	conn, err := r.dialWithAuth(ctx)
	if err != nil {
		return err
	}
...
// productToDomain converts a productspb.Product into our internal domain.Product.
func (r ProductClient) productToDomain(pb *productspb.Product) *domain.Product {
	if pb == nil {
		return nil
	}
	...
	opts := make([]domain.Option, len(pb.GetOptions()))
...
func (r ProductClient) dial(ctx context.Context) (*grpc.ClientConn, error) {
	return rpc.Dial(ctx, r.endpoint)
}

func (r ProductClient) dialWithAuth(ctx context.Context) (*grpc.ClientConn, error) {
...
func (r ProductClient) GetCatalog(ctx context.Context, userID string, page int64, pageSize int64, sortBy string, sortOrder string) ([]*domain.Product, error) {
...
func (r ProductClient) GetPublicCatalog(ctx context.Context, userID string, page int64, pageSize int64, sortBy string, sortOrder string) ([]*domain.Product, error) {
...
func (r ProductClient) UpdateProductPrice(ctx context.Context, userID string, productID string, newPrice int64, oldPrice int64) error {
...
func (r ProductClient) AdjustProductStock(ctx context.Context, userID string, productID string, newStock int64) error {
...
func (r ProductClient) ArchiveProduct(ctx context.Context, userID string, productID string) error {
...
func (r ProductClient) MarkProductSold(ctx context.Context, userID string, productID string) error {
...
func (r ProductClient) MarkProductLeased(ctx context.Context, userID string, productID string, monthlyPrice int64, leaseTermMonths int64) error {
...
func (r ProductClient) MarkProductPawned(ctx context.Context, userID string, productID string, lockedPrice int64, redemptionFee int64) error {
...
func (r ProductClient) IncreaseProductPrice(ctx context.Context, userID string, productID string, price int64) error {
...
func (r ProductClient) DecreaseProductPrice(ctx context.Context, userID string, productID string, newPrice int64) error {
...
func (r ProductClient) AddProductThumbnail(ctx context.Context, productID string, thumbnail string) error {
