...
type CreateInvoiceParams struct {
	...
	// Body.
	Body *models.ErppbCreateInvoiceRequest
...
func (o *CreateInvoiceParams) WithBody(body *models.ErppbCreateInvoiceRequest) *CreateInvoiceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create invoice params
func (o *CreateInvoiceParams) SetBody(body *models.ErppbCreateInvoiceRequest) {
	o.Body = body
}
